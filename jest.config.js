...
module.exports = {
  ...
  // moduleDirectories: ["node_modules", "<rootDir>/app/assets/builds"],
  moduleDirectories: [
    "node_modules",
    "<rootDir>/app/assets/builds",
  ...
  // moduleNameMapper: {
  //   "i18n-js": "<rootDir>/__mocks__/i18n.js"
  // },
  ...
  testMatch: ["<rootDir>/app/**/__tests__/*.test.[jt]s?(x)"],
  ...
  // Requires to be set due to https://github.com/salesforce/tough-cookie/issues/246
  testEnvironmentOptions: {
  ...
  transformIgnorePatterns: ["/node_modules/(?!i18n-js)", "\\.pnp\\.[^\\/]+$"],
