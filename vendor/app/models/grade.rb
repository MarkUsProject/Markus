...
class Grade < ActiveRecord::Base
  ...
  validates_numericality_of :grade, :greater_than_or_equal_to => 0,
                            :message => I18n.t('grade_entry_forms.invalid_grade'), :allow_nil => true
  validates_numericality_of :grade_entry_item_id, :only_integer => true, :greater_than => 0,
                            :message => I18n.t('invalid_id')
  validates_numericality_of :grade_entry_student_id, :only_integer => true, :greater_than => 0,
                            :message => I18n.t('invalid_id')
