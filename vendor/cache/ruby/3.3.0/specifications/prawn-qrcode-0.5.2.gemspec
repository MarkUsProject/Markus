...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<prawn>.freeze, [">= 1".freeze])
  s.add_runtime_dependency(%q<rqrcode>.freeze, [">= 1.0.0".freeze])
  s.add_development_dependency(%q<bundler>.freeze, ["~> 2.0".freeze])
  s.add_development_dependency(%q<minitest>.freeze, ["~> 5.12".freeze, ">= 5.12.2".freeze])
