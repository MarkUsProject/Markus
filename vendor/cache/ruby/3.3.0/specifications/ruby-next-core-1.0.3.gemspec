# -*- encoding: utf-8 -*-
# stub: ruby-next-core 1.0.3 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.add_development_dependency(%q<require-hooks>.freeze, ["~> 0.2".freeze])
  s.add_development_dependency(%q<ruby-next-parser>.freeze, [">= 3.2.2.0".freeze])
  s.add_development_dependency(%q<unparser>.freeze, ["~> 0.6.0".freeze])
  s.add_development_dependency(%q<paco>.freeze, ["~> 0.2".freeze])
end
