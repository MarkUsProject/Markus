...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<redis-namespace>.freeze, [">= 0".freeze])
  s.add_runtime_dependency(%q<browser>.freeze, [">= 0".freeze])
  s.add_development_dependency(%q<activestorage>.freeze, [">= 0".freeze])
  ...
  s.add_development_dependency(%q<otr-activerecord>.freeze, [">= 0".freeze])
  s.add_development_dependency(%q<sidekiq>.freeze, [">= 0".freeze])
  s.add_development_dependency(%q<mimemagic>.freeze, [">= 0".freeze])
