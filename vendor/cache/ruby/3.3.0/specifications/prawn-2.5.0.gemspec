...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<pdf-core>.freeze, ["~> 0.10.0".freeze])
  s.add_runtime_dependency(%q<ttfunk>.freeze, ["~> 1.8".freeze])
  s.add_development_dependency(%q<pdf-inspector>.freeze, [">= 1.2.1".freeze, "< 2.0.a".freeze])
  s.add_development_dependency(%q<pdf-reader>.freeze, ["~> 1.4".freeze, ">= 1.4.1".freeze])
  s.add_development_dependency(%q<prawn-dev>.freeze, ["~> 0.4.0".freeze])
  s.add_development_dependency(%q<prawn-manual_builder>.freeze, ["~> 0.4.0".freeze])
end
