...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<redis>.freeze, [">= 3.3".freeze])
  s.add_runtime_dependency(%q<resque>.freeze, [">= 1.27".freeze])
  s.add_runtime_dependency(%q<rufus-scheduler>.freeze, ["~> 3.2".freeze, "!= 3.3".freeze])
end
