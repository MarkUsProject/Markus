...
Gem::Specification.new do |s|
  ...
  s.add_development_dependency(%q<pg>.freeze, ["~> 0.19.0".freeze])
  s.add_development_dependency(%q<rspec>.freeze, ["~> 3.2".freeze])
  s.add_development_dependency(%q<values>.freeze, ["~> 1.8".freeze])
  s.add_runtime_dependency(%q<activerecord>.freeze, [">= 4.0.2".freeze])
