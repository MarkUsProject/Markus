...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/fnando/glob/issues", "changelog_uri" => "https://github.com/fnando/glob/tree/v0.4.0/CHANGELOG.md", "documentation_uri" => "https://github.com/fnando/glob/tree/v0.4.0/README.md", "homepage_uri" => "https://github.com/fnando/glob", "license_uri" => "https://github.com/fnando/glob/tree/v0.4.0/LICENSE.md", "rubygems_mfa_required" => "true", "source_code_uri" => "https://github.com/fnando/glob/tree/v0.4.0" } if s.respond_to? :metadata=
