...
class PenaltyDecayPeriodSubmissionRuleTest < ActiveSupport::TestCase
  fixtures :all
  context "Marks decay with a penalty deducted every interval over a period of time." do
    ...
    setup do
      ...
      penalty_decay_period_submission_rule = PenaltyDecayPeriodSubmissionRule.new
      @assignment.replace_submission_rule(penalty_decay_period_submission_rule)
      penalty_decay_period_submission_rule.save
      ...
      pretend_now_is(Time.parse("July 1 2009 1:00PM")) do
        ...
        # Add two 24 hour penalty periods, each with a 10% penalty every 12 hours
    ...
    should "add a 10% penalty to the submission result" do
      ...
      pretend_now_is(Time.parse("July 28 2009 1:00PM")) do
        ...
        # We should have all files except NotLincluded.java in the repository.
        assert_not_nil submission.submission_files.find_by_filename("TestFile.java")
        assert_not_nil submission.submission_files.find_by_filename("Test.java")
        assert_not_nil submission.submission_files.find_by_filename("Driver.java")
