class Mark < ActiveRecord::Base
  belongs_to :result
  validates_presence_of :result_id, :criterion, :mark
  ...
  validates_numericality_of :criterion, :only_integer => true, :greater_than => 0, :message => "Criterion must be an id that is an integer greater than 0"
end
