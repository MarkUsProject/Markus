...
Markus::Application.configure do
  ...
  ATE_TEST_RUNNER_NAME = "#{::Rails.root.to_s}/automated-tests-files/test_runner/testrunner.rb"
  ...
  # script is executed.
  ATE_TEST_RUN_DIRECTORY = "#{::Rails.root.to_s}/automated-tests-files/test_runner/test"
