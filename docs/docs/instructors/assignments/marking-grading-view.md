...
- Filter submissions by one or more of the following:
    ...
    - **Submission Scope**: Graders with the "Manage submissions" permission can choose whether the "Next" and "Previous" buttons navigate through only their assigned submissions or through all submissions. The "Only assigned submissions" option is enabled by default. Graders without this permission continue to navigate only their assigned submissions.
