---
permalink: /instructors/assignments/marking-criteria/
...
If you wish to learn more about how to grade an assignment (and about how your criterion changes affect what the graders can see and do) check out the [Marking an Assignment](marking-grading-view.md) page.
