...
- Manage submissions: Grader can collect submissions, release/unrelease grades, and choose whether to work with all submissions or only submissions assigned to them in the submissions table, summary table, and grading view
