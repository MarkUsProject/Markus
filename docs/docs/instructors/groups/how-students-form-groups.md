---
permalink: /instructors/groups/how-students-form-groups/
title: How Students Form Groups
parent: Groups
...
![Student Create Group](/images/student-create-group.png)

Once this is done, the inviter will have to invite each member of their team to the group:

![Students Invite Students](/images/students-invite-students.png)

![Students invite students 2](/images/students-invite-students-2.png)

If a student is not eligible to be a part of their group they will receive a warning:

![Could not invite](/images/could-not-invite.png)
...
> ⚠️ **WARNING:** When adding other students to their group, the inviter must type in their teammate's exact username (case-sensitive) and not just their first/last name.
