---
permalink: /administrators/admin-dashboards/
...
> 🗒️ **Note**: Ensure that you are viewing MarkUs as an admin and have not switched roles. Otherwise, you will be unable to access the "Administration" tab.
