---
permalink: /developers/set-up-with-vagrant/
title: Set Up With Vagrant
parent: Developers
nav_order: 2
---
# Set Up with Vagrant
...
2. Clone the Markus repo from GitHub by following the instructions in [Setting up Git and MarkUs](setting-up-git.md).  (This is a document you will want to read very carefully and may come back to.)
