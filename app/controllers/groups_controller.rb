...
class GroupsController < ApplicationController
  ...
  def create
    ...
    m_logger = MarkusLogger.instance
    handle_unauthorized(reraise: true, additional_errors: RuntimeError) do
    ...
    rescue ActionPolicy::Unauthorized, RuntimeError => e
  ...
  def destroy
    ...
    handle_unauthorized(additional_errors: RuntimeError, reraise: true) do
  ...
  def invite_member
    ...
    if handle_unauthorized { authorize! @grouping, to: :invite_member? }
  ...
  def disinvite_member
    ...
    authorized = handle_unauthorized do
