  ...
  class AssignmentsController < MainApiController
    ...
    def index
      ...
      respond_to do |format|
        format.any{render :text => get_plain_text('assignment', assignments, fields)}
    ...
    def show
      ...
      if !!(params[:id] =~ /^[0-9]+$/)
        ...
        if assignment.nil?
          ...
          respond_to do |format|
            format.any{render :text => get_plain_text('assignment', assignment, 
              fields)}
    ...
    # Optional: 
    def create
      if has_missing_params?([:short_identifier, :due_date])
