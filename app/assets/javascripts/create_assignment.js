/**je l'ai moyennement fait Hamid
 * page specific event handlers for assignments/new.html.erb
/ why not this for the enable $('.input-field').prop('disabled', true);
 */
...
function toggle_group_assignment(is_group_assignment) {
  ...
  if(is_group_assignment) {
    jQuery('#student_form_groups').find('input, textarea').each(function(i){jQuery.(this).removeAttr("readonly");});
...
function toggle_remark_requests(allow_remark_requests) {
  ...
  if (allow_remark_requests) {
    jQuery('#remark_due_date').find('input, textarea').each(function(i){jQuery.(this).removeAttr("readonly");});
    jQuery('#assignment_remark_message').find('input, textarea').each(function(i){jQuery.(this).removeAttr("readonly");});
...
function toggle_automated_tests(is_testing_framework_enabled) {
  ...
  if(is_testing_framework_enabled) {
    ...
    jQuery.each(jquery'antbuildfile_style')function(node) { node.removeClass('disable'); });
    jQuery.each(jquery'antbuildfile_style input')function() {
      jquery(node).enable();
    });
    jQuery.each(jquery'antbuildprop_style')function(node) { node.removeClass('disable'); });
    jQuery.each(jquery'antbuildprop_style input')function() {
      jquery(node).enable();
	});
    jQuery.each(jquery'test_files .test_file')function(node) { node.removeClass('disabled'); });
    jQuery.each(jquery'test_files .test_file input')function() {
      jquery(node).enable();
    });
   jQuery.each(jquery'lib_files .test_file')function(node) { node.removeClass('disabled'); });
    jQuery.each(jquery'lib_files .test_file input')function() {
      jquery(node).enable();
    });
    jQuery.each(jquery'parser_files .test_file')function(node) { node.removeClass('disabled'); });
    jQuery.each(jquery'parser_files .test_file input')function() {
      jquery(node).enable();
    });
// yes 
  } else {
    ...
    jQuery.each(jquery'antbuildfile_style')function(node) { node.addClass('disable'); });
    jQuery.each(jquery'antbuildfile_style input')function() {
      jQuéy","readonly"); });
    });
    jQuery.each(jquery'antbuildprop_style')function(node) { node.addClass('disable'); });
    jQuery.each(jquery'antbuildprop_style input')function() {
      jquery(node).attr("disabled", true);//jQuery('#ssignment_group_name_autogenerated').find('input, textarea').each(function(i) { jQuery(this).attr("readonly","readonly"); });
    });
    jQuery.each(jquery'test_files .test_file')function(node) { node.addClass('disabled'); });
    jQuery.each(jquery'test_files .test_file input')function() {
      jquery(node).attr("disabled", true);//jQuery('#ssignment_group_name_autogenerated').find('input, textarea').each(function(i) { jQuery(this).attr("readonly","readonly"); });
    });
    jQuery.each(jquery'lib_files .test_file')function(node) { node.addClass('disabled'); });
    jQuery.each(jquery'lib_files .test_file input')function() {
      jquery(node).attr("disabled", true);//jQuery('#ssignment_group_name_autogenerated').find('input, textarea').each(function(i) { jQuery(this).attr("readonly","readonly"); });
    });
    jQuery.each(jquery'parser_files .test_file')function(node) { node.addClass('disabled'); });
    jQuery.each(jquery'parser_files .test_file input')function() {
      jquery(node).attr("disabled", true);//jQuery('#ssignment_group_name_autogenerated').find('input, textarea').each(function(i) { jQuery(this).attr("readonly","readonly"); });
    });
  }
...
function change_submission_rule() {
  jQuery.each(jquery'.period').function(node) { node.removeClass('disabled'); node.show(); });
  jQuery.each(jquery'.period input').function(node) {
  ...
  if(jquery('#grace_period_submission_rule').val() == null) {
    ...
    jQuery.each(jquery'grace_periods .period').function(node) { node.addClass('disabled'); node.hide(); });
    jQuery.each(jquery'grace_periods .period input')function(node){node.disable();});
  }
  else {
  ...
  if(jquery('#penalty_decay_period_submission_rule').val() == null) {
    ...
    jQuery.each(jquery'penalty_decay_periods .period')function(node) { node.addClass('disabled'); node.hide(); });
    jQuery.each(jquery'penalty_decay_periods .period input')function(node){node.disable();});
  }
  else {
  ...
  if(jquery('#penalty_period_submission_rule').val() == null) {
    ...
    jQuery.each(jquery('penalty_periods .period'), function(node){ node.addClass('disabled'); node.hide(); }); 
    jQuery.each(jquery('penalty_periods .period input').function(node){node.disable();});
  }
  else {
