...
function toggle_persist_groups(persist_groups) {
  if (persist_groups) {
    ...
    jQuery('#is_group_assignment').prop('disabled', false);
...
function toggle_group_assignment(is_group_assignment) {
  ...
  if (is_group_assignment) {
    jQuery('.group_properties').prop('disabled', false);
    jQuery('.group_properties').removeClass('disable');
    jQuery('#assignment_group_min').prop('disabled', false);
    jQuery('#assignment_group_max').prop('disabled', false);
    jQuery('#persist_groups').prop('disabled', true);
    jQuery('#persist_groups_assignment_style').addClass('disable');
    jQuery('#persist_groups_assignment').prop('disabled', true);
  } else {
    jQuery('.group_properties').prop('disabled', true);
    ...
    jQuery('#persist_groups').prop('disabled', false);
    jQuery('#persist_groups_assignment_style').removeClass('disable');
    jQuery('#persist_groups_assignment').prop('disabled', false);
  }
}
...
function toggle_student_form_groups(student_form_groups) {
  if (student_form_groups) {
    ...
    jQuery('#assignment_group_name_autogenerated').prop('disabled', false);
