...
function toggle_persist_groups(persist_groups) {
  if(persist_groups) {
    ...
    jQuery('#is_group_assignment').attr("disabled", false);
...
function toggle_group_assignment(is_group_assignment) {
  ...
  if(is_group_assignment) {
    jQuery('#student_form_groups').attr("disabled", false);
    jQuery('student_form_groups_style').removeClass('disable');
    jQuery('#persist_groups').find('input, textarea').each(function(i) { jQuery(this).attr("readonly","readonly"); });
    jQuery('persist_groups_assignment_style').addClass('disable');
...
function toggle_student_form_groups(student_form_groups) {
  if(student_form_groups) {
    jQuery('#assignment_group_min').attr("disabled", false);
    jQuery('#assignment_group_max').attr("disabled", false);
    ...
    jQuery('#assignment_group_max').find('input, textarea').each(function(i) { jQuery(this).attr("readonly","readonly"); });
    jQuery('group_limit_style').addClass('disable');
    jQuery('#assignment_group_name_autogenerated').attr("disabled", false);
...
function toggle_automated_tests(is_testing_framework_enabled) {
  ...
  if(is_testing_framework_enabled) {
    ...
    jQuery("antbuildfile_style input").each(function() {
      jQuery(node).find('input, textarea').attr("disabled", false);
    });
...
// yes 
    ...
    jQuery("antbuildfile_style input").each(function(node) {
...
function change_submission_rule() {
  ...
  if(jQuery('#grace_period_submission_rule').val() == null) {
    ...
    jQuery("grace_periods .period input").each(function(node){jQuery(node).find('input, textarea').each(function(i){jQuery(this).attr("readonly","readonly");});});
  }
  else {
  ...
  if(jQuery('#penalty_decay_period_submission_rule').val() == null) {
    ...
    jQuery("penalty_decay_periods .period input").each(function(node){jQuery(node).find('input, textarea').each(function(i){jQuery(this).attr("readonly","readonly");});});
  }
  else {
  ...
  if(jQuery('#penalty_period_submission_rule').val() == null) {
    ...
    jQuery("penalty_periods .period input").each(function(node){jQuery(node).find('input, textarea').each(function(i){jQuery(this).attr("readonly","readonly");});});
  }
  else {
