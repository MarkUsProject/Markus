...
function toggle_persist_groups(persist_groups) {
  if(persist_groups) {
    ...
    jQuery("#assignment_group_name_autogenerated").attr("disabled", true);
    jQuery('is_group_assignment_style').addClass('disable');
  } else {
    jQuery("#persist_groups_assignment").attr("disabled", true);
...
function toggle_remark_requests(allow_remark_requests) {
  ...
  if (allow_remark_requests) {
    jQuery("#remark_due_date").attr("disabled", true);
    jQuery("#assignment_remark_message").attr("disabled", true);
