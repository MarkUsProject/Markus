...
class Group < ActiveRecord::Base
  ...
  def repository_external_access_url
    return MarkusConfigurator.markus_config_repository_external_base_url + "/" + repository_name
  end
  ...
  def repo
    ...
    if Repository.get_class(MarkusConfigurator.markus_config_repository_type, self.repository_config).repository_exists?(repo_loc)
      return Repository.get_class(MarkusConfigurator.markus_config_repository_type, self.repository_config).open(repo_loc)
    else
