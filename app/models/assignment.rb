...
class Assignment < Assessment
  ...
  def assignment_properties_config
    ...
    if self.scanned_exam
      scanned_fields = [:remark_due_date, :remark_message, :assign_graders_to_criteria,
                        :allow_remarks, :display_grader_names_to_students, :display_median_to_students,
                        :has_peer_review, :section_groups_only, :section_due_dates_type,
                        :scanned_exam, :hide_unassigned_criteria, :starter_file_type, :starter_files_after_due]
      ...
      assignment_fields = [:group_min, :group_max, :allow_web_submits, :student_form_groups, :remark_due_date,
                           ...
                           :hide_unassigned_criteria, :duration, :start_time, :is_timed, :starter_file_type,
                           :starter_files_after_due]
