...
class Assignment < Assessment
  ...
  def assignment_properties_config
    properties = {}
    other_properties = {}
    fields = [:short_identifier, :description, :due_date, :message, :is_hidden, :type, :show_total]
    assignment_fields = [:group_min, :group_max, :tokens_per_period, :allow_web_submits,
                         ...
                         :assign_graders_to_criteria, :enable_test, :enable_student_tests,
                         :allow_remarks, :display_grader_names_to_students, :display_median_to_students,
                         :group_name_autogenerated, :vcs_submit, :has_peer_review, :group_name_displayed,
                         :invalid_override, :section_groups_only, :section_due_dates_type, :unlimited_tokens,
                         :only_required_files, :token_start_date, :token_period, :non_regenerating_tokens,
