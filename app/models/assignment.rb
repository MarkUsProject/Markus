...
class Assignment < Assessment
  ...
  def assignment_properties_config
    ...
    if self.scanned_exam
      ...
      assignment_fields = [:group_min, :group_max, :tokens_per_period, :allow_web_submits,
                           :student_form_groups, :remark_due_date, :remark_message, :assign_graders_to_criteria,
                           :enable_test, :enable_student_tests, :allow_remarks, :display_grader_names_to_students,
