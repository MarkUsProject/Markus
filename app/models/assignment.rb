...
class Assignment < Assessment
  ...
  def all_grouping_data
    ...
    grouping_data = self
                    ...
                    .left_outer_joins(non_rejected_student_memberships: :user).where('users.hidden': false)
  ...
  def current_submission_data(current_user)
    if current_user.admin?
      groupings = self.groupings.joins(student_memberships: :user).where('users.hidden': false)
