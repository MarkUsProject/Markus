class ExtraMark < ActiveRecord::Base
  ...
  named_scope :positive_points, :conditions => ['extra_mark > 0', {:unit => ExtraMark::UNITS[:points]}]
  named_scope :negative_points, :conditions => ['extra_mark < 0', {:unit => ExtraMark::UNITS[:points]}]

  named_scope :positive_percentage, :conditions => ['extra_mark > 0', {:unit => ExtraMark::UNITS[:percentage]}]
  named_scope :negative_percentage, :conditions => ['extra_mark < 0', {:unit => ExtraMark::UNITS[:percentage]}]
