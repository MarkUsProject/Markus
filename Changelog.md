...
- Added a grading filter option that lets graders with manage submissions permission navigate either all submissions or only their assigned submissions (#8047)
