...
--
-- Name: annotation_texts; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE annotation_texts (
    id integer NOT NULL,
    content text,
...
ALTER SEQUENCE annotation_labels_id_seq OWNED BY annotation_texts.id;
...
--
-- Name: extra_marks; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--
...
CREATE SEQUENCE extra_marks_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MAXVALUE
    NO MINVALUE
...
ALTER SEQUENCE extra_marks_id_seq OWNED BY extra_marks.id;
...
CREATE TABLE results (
    ...
    marking_state character varying(255),
    overall_comment character varying(255),
    created_at timestamp without time zone,
    updated_at timestamp without time zone
);
...
--
-- Name: rubric_criteria; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE rubric_criteria (
    id integer NOT NULL,
    rubric_criterion_name character varying(255) NOT NULL,
    assignment_id integer NOT NULL,
...
CREATE SEQUENCE rubric_criteria_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MAXVALUE
    NO MINVALUE
...
ALTER SEQUENCE rubric_criteria_id_seq OWNED BY rubric_criteria.id;
...
CREATE TABLE submission_files (
    ...
    submission_file_status character varying(255)
);
...
CREATE TABLE submissions (
    ...
    submission_version_used boolean
);
...
ALTER TABLE annotation_texts ALTER COLUMN id SET DEFAULT nextval('annotation_labels_id_seq'::regclass);
...
ALTER TABLE extra_marks ALTER COLUMN id SET DEFAULT nextval('extra_marks_id_seq'::regclass);
...
ALTER TABLE groupings ALTER COLUMN id SET DEFAULT nextval('groupings_id_seq'::regclass);
...
ALTER TABLE marks ALTER COLUMN id SET DEFAULT nextval('marks_id_seq'::regclass);
...
ALTER TABLE rubric_criteria ALTER COLUMN id SET DEFAULT nextval('rubric_criteria_id_seq'::regclass);
...
ALTER TABLE ONLY annotation_texts
...
--
-- Name: extra_marks_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY extra_marks
...
--
-- Name: rubric_criteria_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY rubric_criteria
...
CREATE INDEX index_annotations_on_description_id ON annotations USING btree (annotation_text_id);
...
--
-- Name: index_rubric_criteria_on_assignment_id_and_name; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE UNIQUE INDEX index_rubric_criteria_on_assignment_id_and_name ON rubric_criteria USING btree (assignment_id, rubric_criterion_name);
...
--
-- Name: fk_annotations_annotation_texts; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY annotations
    ADD CONSTRAINT fk_annotations_annotation_texts FOREIGN KEY (annotation_text_id) REFERENCES annotation_texts(id);
...
--
-- Name: fk_extra_marks_results; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY extra_marks
    ADD CONSTRAINT fk_extra_marks_results FOREIGN KEY (result_id) REFERENCES results(id) ON DELETE CASCADE;


--
-- Name: fk_groupings_assignments; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY groupings
    ADD CONSTRAINT fk_groupings_assignments FOREIGN KEY (assignment_id) REFERENCES assignments(id);


--
-- Name: fk_groupings_groups; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY groupings
    ADD CONSTRAINT fk_groupings_groups FOREIGN KEY (group_id) REFERENCES groups(id);


--
-- Name: fk_marks_results; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY marks
    ADD CONSTRAINT fk_marks_results FOREIGN KEY (result_id) REFERENCES results(id) ON DELETE CASCADE;


--
-- Name: fk_marks_rubric_criteria; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY marks
    ADD CONSTRAINT fk_marks_rubric_criteria FOREIGN KEY (rubric_criterion_id) REFERENCES rubric_criteria(id) ON DELETE CASCADE;


--
-- Name: fk_memberships_groupings; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY memberships
    ADD CONSTRAINT fk_memberships_groupings FOREIGN KEY (grouping_id) REFERENCES groupings(id);
...
--
-- Name: fk_results_submissions; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY results
    ADD CONSTRAINT fk_results_submissions FOREIGN KEY (submission_id) REFERENCES submissions(id) ON DELETE CASCADE;


--
-- Name: fk_rubric_criteria_assignments; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY rubric_criteria
    ADD CONSTRAINT fk_rubric_criteria_assignments FOREIGN KEY (assignment_id) REFERENCES assignments(id) ON DELETE CASCADE;
...
INSERT INTO schema_migrations (version) VALUES ('20090212060750');

INSERT INTO schema_migrations (version) VALUES ('20090212060818');
...
INSERT INTO schema_migrations (version) VALUES ('20090219195620');

INSERT INTO schema_migrations (version) VALUES ('20090219215958');

INSERT INTO schema_migrations (version) VALUES ('20090220200053');

INSERT INTO schema_migrations (version) VALUES ('20090326022851');

INSERT INTO schema_migrations (version) VALUES ('20090511210106');

INSERT INTO schema_migrations (version) VALUES ('20090512133754');

INSERT INTO schema_migrations (version) VALUES ('20090512133912');

INSERT INTO schema_migrations (version) VALUES ('20090512173025');

INSERT INTO schema_migrations (version) VALUES ('20090512182004');

INSERT INTO schema_migrations (version) VALUES ('20090512193837');

INSERT INTO schema_migrations (version) VALUES ('20090512200945');

INSERT INTO schema_migrations (version) VALUES ('20090513155255');

INSERT INTO schema_migrations (version) VALUES ('20090515135136');

INSERT INTO schema_migrations (version) VALUES ('20090515135140');

INSERT INTO schema_migrations (version) VALUES ('20090515141319');

INSERT INTO schema_migrations (version) VALUES ('20090515141902');

INSERT INTO schema_migrations (version) VALUES ('20090515142434');

INSERT INTO schema_migrations (version) VALUES ('20090515172919');

INSERT INTO schema_migrations (version) VALUES ('20090515201727');

INSERT INTO schema_migrations (version) VALUES ('20090519140333');