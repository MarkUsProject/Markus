...
ActiveRecord::Schema.define(version: 20150724162632) do
  ...
  add_index "assignments", ["short_identifier"], name: "index_assignments_on_name", unique: true, using: :btree
  ...
  add_index "rubric_criteria", ["assignment_id", "rubric_criterion_name"], name: "index_rubric_criteria_on_assignment_id_and_name", unique: true, using: :btree
