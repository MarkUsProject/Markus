...
ActiveRecord::Schema.define(:version => 20091125173242) do
  ...
  create_table "assignments", :force => true do |t|
    t.string   "short_identifier",         :default => "", :null => false
  ...
  create_table "flexible_criteria", :force => true do |t|
    t.string   "flexible_criterion_name",                                :default => "", :null => false
    t.text     "description"
    t.integer  "position"
    t.integer  "assignment_id",                                                          :null => false
  ...
  create_table "notes", :force => true do |t|
    t.string   "notes_message", :default => "", :null => false
    t.integer  "creator_id",                    :null => false
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "noteable_id",                   :null => false
    t.string   "noteable_type", :default => "", :null => false
  end
  ...
  create_table "rubric_criteria", :force => true do |t|
    t.string   "rubric_criterion_name", :default => "", :null => false
    t.integer  "assignment_id",                         :null => false
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "position"
