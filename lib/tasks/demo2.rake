namespace :markus do
  ...
  def submit_files(group, a)
    group.access_repo do |repo|
      ...
      copy_dir(file_dir, txn, a.repository_folder)
      repo.commit(txn)
    end
  end
  ...
  task demo: :environment do
    ...
    puts '4: Penalty Decay Submissions'
    a = Assignment.create(
      short_identifier: 'A4',
    ...
    puts '5: Students work in groups'
    a = Assignment.create(
      short_identifier: 'A5',
