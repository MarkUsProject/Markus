    ...
    describe 'An authenticated and authorized admin doing a GET' do
      ...
      context '#edit' do
        before(:each) do
          get_as @admin,
                 :edit,
                 params: { assessment_id: 1, id: @criterion.id, criterion_type: @criterion.class.to_s },
                 format: :js
        end
      ...
      context '#update' do
        context 'with errors' do
          before(:each) do
            ...
            get_as @admin,
                   :update,
                   params: { assessment_id: 1, id: @criterion.id, flexible_criterion: { name: 'one', max_mark: 10 },
      ...
      context '#update' do
        context 'with errors' do
          before(:each) do
            ...
            get_as @admin,
                   :update,
                   params: { assessment_id: 1, id: @criterion.id, rubric_criterion: { name: 'one', max_mark: 10 },
  ...
  describe 'An authenticated and authorized admin performing yml actions' do
    ...
    context 'When a file containing a mixture of entries is uploaded' do
      ...
      it 'creates criteria with rounded (up to first digit after decimal point) maximum mark' do
        post_as @admin, :upload, params: { assessment_id: @assignment.id,
