describe AssignmentsController do
  ...
  describe '#destroy' do
    ...
    it 'should fail to DELETE because assignment has groups' do
      ...
      expect(Assignment.exists?(assignment.id)).to be(true)
      expect(flash[:error]).to have_message('assignments.assignment_has_groupings')
    ...
    it 'should successfully DELETE assignment (no groups)' do
      ...
      expect(flash[:success]).to have_message('flash.actions.destroy.success',
    ...
    it 'rescues from StandardError and sets flash message' do
      ...
      expect(flash[:error]).to contain_message('activerecord.errors.models.assignment_deletion',
