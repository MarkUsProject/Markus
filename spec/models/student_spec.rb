  ...
  context 'A Student' do
    ...
    context 'with an assignment' do
      ...
      it 'should correctly return if it has accepted groupings' do
        ...
        membership = create(:student_membership, user: @student, grouping: @grouping,
      ...
      it 'should raise when creating an autogenerated name group' do
        ...
        # TODO create_autogenerated_name_group currently raises a string, shown below.
        #FAILING
        @autogenerated = @student.create_autogenerated_name_group(@assignment.id)
        expect(@autogenerated).to raise_error
      end
    end
    ...
    context 'with grace credits' do
      ...
      it 'return normally when over deducted' do
        membership = create(:student_membership, user: @student)
        deduction1 = create(:GracePeriodDeduction, membership: membership)
        deduction2 = create(:GracePeriodDeduction, membership: deduction1.membership, deduction: 10)
    ...
    context 'as a noteable' do
      it 'display for note without seeing an exception' do
        expect(@student.display_for_note)
      end
    end
