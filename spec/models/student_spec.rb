...
describe Student do
  ...
  context 'A hidden Student' do
      ...
      it 'should not become a member of a grouping' do
        ...
        pending_memberships = @student.pending_memberships_for(grouping.assessment_id)
  ...
  context 'A Student' do
    ...
    context 'with an assignment' do
      before(:each) do
        @assignment = create(:assignment, assignment_properties_attributes: { group_name_autogenerated: false })
      end
